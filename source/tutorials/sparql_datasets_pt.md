...
Essa sessão cobre datasets RDF – um dataset RDF é a unidade consultada por uma consulta SPARQL. 
...
Pode haver mais de uma cláusula `FROM` e o grafo padrão é resultado da leitura de cada arquivo no grafo padrão. 
...
Como muitas cláusulas FROM podem ser fornecidas, o dado pode ser lido de vários lugares, 

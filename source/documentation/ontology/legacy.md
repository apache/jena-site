---
title: Legacy Jena Ontology API
---

This section is a general introduction to the (Legacy) Jena
...
_Please note that this section covers the old (deprecated) Jena ontology API. 
Starting with Jena 5.1.0, there is a new [Jena ontology API](./)._
### Prerequisites
